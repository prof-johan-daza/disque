...
<tr>
<td>II. Masse volumique (rappels sur la masse et le volume, relation <span class="arithmatex">\(m = \rho \times V\)</span> , propriétés, la masse volumique un outil d’identification).</td>
<td>
...
<tr>
<td>II. Les ions (définition et formation, tests caractéristiques d’identification, notion d’élément chimique et tableau périodique).</td>
<td>
...
<tr>
<td>IV. Transformation chimique (rappel de la définition, distinction avec les mélanges et les transformations physiques, modélisation par une réaction avec interprétation comme une redistribution d’atomes et écriture symbolique de l’équation, exemples de transformations-combustion, réactions acide-base, réaction métal acide).</td>
<td>
